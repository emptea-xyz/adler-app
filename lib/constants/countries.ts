// Auto-generated from ISO-3166-1 alpha-2 canonical codes via Node Intl.DisplayNames.
// Sorted alphabetically by English name. 250 entries.
...
/** Render an ISO-3166-1 alpha-2 code as a flag emoji.
 *  iOS renders these natively; on web/Android coverage is OS-dependent. */
export function codeToFlag(code: string): string {
    if (!code || code.length !== 2) return '';
    const A = 0x1F1E6 - 0x41;
    return String.fromCodePoint(A + code.charCodeAt(0)) + String.fromCodePoint(A + code.charCodeAt(1));
}
